...
\noindent
  ...
  \begin{itemize}
\item   n which waves arriving at the interface (boundary) from one medium to another
...
\item Specular reflection, or regular reflection, is the mirror-like reflection of waves, such as light, from a surface.[1]
