...
\noindent
  ...
  charged particle ionizes the material. The light is emitted isotropically from the point where it is produced. 
 ...
 Cherenkov radiation is electromagnetic radiation emitted when a charged particle (such as an electron) passes through a dielectric medium at a speed greater than the phase velocity (speed of propagation of a wavefront in a medium) of light in that medium.
  herenkov radiation as conical wave front
...
40,000 photons / MeV, E = 0 V / cm
  ...
  of which has a different characteristic time constant. The emmssion spectra are passed to Geant4
...
\begin{table}[h!]
  \begin{center}
    ...
    \begin{tabular}{|c|c|} 
      \hline
      optical material property & Geant4 Keyword\\
      \hline
...
\begin{table}[h!]
  \begin{center}
    ...
    \begin{tabular}{|c|c|c|} 
      \hline
      optical material property & Geant4 Keyword & value\\
      \hline
      ...
      emmission time const                           &  WLSTIMECONSTANT        & 0.5 ns  \\
      \hline
    \end{tabular}
  \end{center}
...
\end{center}
\caption{\label{fig:wls} TPB wave length spectrum extracted form \cite{ref:wls}.}
\end{figure}
