...
\section{Introduction}
  ...
  index or rayleigh scattering length are inputs that have to be provided when the detector is constructed.  High-precision modeling of 
...
In this article we briefly
  ...
  A nice overview about the properties of Scintillation Light in Liquid Argon can befound in \cite{ref:ben}.
...
\clearpage
 ...
 \begin{thebibliography}{99}
    \bibitem{ref:geant4}
   Instruments and Methods in Physics Research A 506 (2003) 250-303,  IEEE Transactions on Nuclear Science 53 No. 1 (2006) 270-278 and Nuclear Instruments and Methods in Physics Research A 835 (2016) 186-225
